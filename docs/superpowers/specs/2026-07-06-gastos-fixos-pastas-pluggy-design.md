...
- FR-151: Navegação web: sidebar escura com grupos — principal (Início, Histórico, Categorias, Pastas), "Contas" (Gastos Fixos, Cobranças, Faturas), "Automação" (Conexões, Agente), Sair. Mobile: 4 tabs (Início, Histórico, Fixos, Mais) com stack "Mais" (Pastas, Categorias, Cobranças, Faturas, Conexões, Agente, Sair). *(Dashboard/Dash removidos em 2026-07-10 — fundidos com Início, ver `2026-07-10-fusao-inicio-dashboard-design.md`.)*
